...
public class LoginAPI {
    ...
    static  int getPodNum()
    {
        ...
        System.out.println("14. AP SOUTHEAST AZURE : "+Utilities.AP_SOUTHEAST_AZURE);
        System.out.println("15. AP NORTHEAST 1 AZURE : "+Utilities.AP_NORTHEAST_1_AZURE_LoginURL);
        System.out.println("16. AP NORTHEAST 2 : "+Utilities.AP_NORTHEAST_2_LoginURL);


        System.out.println("17. AUSTRALIA AZURE : "+Utilities.AUSTRALIA_LoginURL);
        System.out.println("18. EM WEST 1 : "+Utilities.EM_WEST_1_LoginURL);

        System.out.println("19. EM CENTRAL 1 AZURE : "+Utilities.EM_CENTRAL_1_AZURE_LoginURL);
        System.out.println("20. UK : "+Utilities.UK_LoginURL);
        System.out.println("21. EM SOUTHEAST 1 AZURE : "+Utilities.EM_SOUTHEAST_1_AZURE_LoginURL);
        System.out.println("22. EM WEST 2 GCP : "+Utilities.EM_WEST_2_GCP_LoginURL);
...
//            System.out.println("Session URL : "+sessionDetails.getServerUrl());
    ...
    public static String getPodURL(int num)
    {
        ...
        switch (num){
            ...
            case 14:
                return Utilities.AP_SOUTHEAST_AZURE;
            case 15:
                return Utilities.AP_NORTHEAST_1_AZURE_LoginURL;
            case 16:
                return Utilities.AP_NORTHEAST_2_LoginURL;
            case 17:
                return Utilities.AUSTRALIA_LoginURL;



            case 18:
                return Utilities.EM_WEST_1_LoginURL;
            case 19:
                return Utilities.EM_CENTRAL_1_AZURE_LoginURL;
            case 20:
                return Utilities.UK_LoginURL;
            case 21:
                return Utilities.EM_SOUTHEAST_1_AZURE_LoginURL;
            case 22:
                return Utilities.EM_WEST_2_GCP_LoginURL;
